            ...
            <div class="card bg-secondary shadow">
                ...
                <form role="form" action="/cuti/{{$cuti->id}}/updating" method="post">
                    ...
                    <div class="row">
                        ...
                        <input type="date" id="input-tgl_pengajuan" name="tgl_pengajuan" class="form-control form-control-alternative" placeholder="Tanggal Pengajuan" value="{{$cuti->tgl_pengajuan}}">
                        </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group focused">
                                <label class="form-control-label" for="input-hari">Jumlah hari</label>
                            <input type="text" id="input-hari" name="hari" class="form-control form-control-alternative" placeholder="Lama Cuti ... hari" value="{{$cuti->hari}}">
                            </div>
                        </div>
                    </div>                    
                    <div class="row">
