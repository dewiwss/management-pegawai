                ...
                <form role="form" action="/golongan/{{$golongan->id}}/updating" method="post">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input required type="text" id="input-id" name="kode_golongan" class="form-control form-control-alternative" placeholder="Kode Golongan" value="{{$golongan->kode_golongan}}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                            <label for="gaji">Gaji</label>
                            <input required type="text" id="gaji" name="gaji" class="form-control form-control-alternative" placeholder="Gaji" value="{{$golongan->gaji}}">
                            </div>
                        </div>
                    </div>
                </div>
